...
import { GradientStop } from "../fractals/types";
import { useMove } from "@mantine/hooks";

export const GradientInput = ({
  initialStops, onChange
}: {
        ...
        <div
          style={{
            ...
            background: `linear-gradient(to right, ${stops
              .map(
                (stop) => `rgba(${stop[1] * 255}, ${stop[2] * 255}, ${stop[3] * 255}, ${stop[4]}) ${stop[0] * 100}%`
              )
              .join(", ")})`,
            borderRadius: 4,
          ...
          <div>
            <ColorInput 
              ...
              onChange={(hex) => {
                ...
                const newStops = [...stops];
                newStops[selectedStop] = [newStops[selectedStop][0], ...rgb, 1.0];
                setStops(newStops);
              }}
            />
