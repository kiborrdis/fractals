...
import { Vector2 } from "../fractals/types";
import { createProgram, createShader } from "../fractals/shader/canvasUtils";
...
export const Simulation = () => {
  ...
  console.log('res', matrixMultiply(toTriangleMatrix, [1, 0]));
  console.log('res2', matrixMultiply(toTriangleMatrix, [0, 1]))
  console.log('res3', matrixMultiply(toBasisMatrix, matrixMultiply(toTriangleMatrix, [1, 0])));
  console.log('res4', matrixMultiply(toBasisMatrix, matrixMultiply(toTriangleMatrix, [0, 1])))
