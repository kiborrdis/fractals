...
- Dynamic params types are located in shared/libs/numberRule. And can be numbers, vectors or array of numbers of vectors. Animated numbers or vectors described as a "rule" which is an object(see numberRule lib)
